                            ...
                            <div className="row">
                                ...
                                <div className="col-2">
                                    ...
                                    <a target="_blank" href="https://www.betacinemas.vn/home.htm">
                                        <img className="iconConnect mb-3" src="./images/bt.jpeg" style={{ backgroundColor: '#fff', width: '30px', borderRadius: '50%' }} />
                                    </a>
                                ...
                                <div className="col-2">
                                    ...
                                    <a target="_blank" href="https://www.payoo.vn/">
                                        <img className="iconConnect mb-3" src="./images/payoo.jpeg" style={{ backgroundColor: '#fff', width: '30px', borderRadius: '50%' }} />
                                    </a>
                                ...
                                <div className="col-2">
                                    ...
                                    <a target="_blank" href="https://cinemaxvn.com/">
                                        <img className="iconConnect mb-3" src="./images/cnx.jpeg" style={{ backgroundColor: '#fff', width: '30px', borderRadius: '50%' }} />
                                    </a>
                        ...
                        <div className="col-9">
                            <div className="d-flex">
                                <div className="logo-left">
                                    <img src="./images/zion-logo.jpeg" alt="" style={{ borderRadius: '15px' }} />
                                </div>
